...
import {Twitter, Home, Explore, Notification, Messages, Bookmark, Lists, Profile, More, HomeFill, ExploreFill, NotificationFill, MessagesFill, BookmarkFill, ListsFill, ProfileFill } from "./icons"
        ...
        <nav className={styles.nav}>
            {
                MENU.map((menu) => {
                    ...
                    return(
                        <NavigationButton key={menu.key} notify={menu.notify} selected={selected}>
